...
def run():
  ...
  bpy.ops.uv.lightmap_pack(PREF_NEW_UVLAYER=True)

  # Create new image
  image = bpy.ops.image.new(name="myLightMap", width=2048, height=2048)

  # Set bake margins
  bpy.context.scene.render.bake_margin = 2

  # Set the UV coordinates
  ob.uv_textures['UVMap'].active = True
  ...
  for d in ob.uv_textures['UVMap'].data:
